...
internal val logger: SkipLogger = SkipLogger(subsystem = "machin.data.matrix", category = "MachinDataMatrix")

private typealias AppRootView = MachinDataMatrixRootView
private typealias AppDelegate = MachinDataMatrixAppDelegate
